...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
                            ...
                            object.saveInBackground(new SaveCallback() {
                                ...
                                public void done(ParseException e) {
                                    ...
                                    if (e == null) {
                                        ...
                                        Intent directionsIntent = new Intent(android.content.Intent.
                                                ACTION_VIEW,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        markers.add(mMap.addMarker(new MarkerOptions().position(requestLocation)
                .title("Request Location").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE))));
